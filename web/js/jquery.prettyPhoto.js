		...
		pp_settings = jQuery.extend({
			...
			markup: '<div class="pp_pic_holder"> \
						...
						<div class="pp_top"> \
							...
							<div class="pp_middle" style="padding-top:3px;"><a class="pp_print" href="'+$(this).attr("print")+'" target="_blank" id="'+$(this).attr("id")+'"><img src="./imgs/btn_print.gif" align="absmiddle" /></a></div> \
								...
								<div class="pp_content"> \
									...
									<div class="pp_fade"> \
										...
										<div class="pp_details clearfix"> \
											...
											<!-- div class="pp_nav" style="display:none"> \
			...
			iframe_markup: '<iframe src ="{path}" width="{width}" height="{height}" frameborder="no" class="overlay-iframe"></iframe>',
		...
		*/
		function _fitToViewport(width,height){
			...
			return {
				...
				contentHeight:Math.floor(pp_contentHeight) - 15,
